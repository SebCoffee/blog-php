        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active"><a href="indexAdmin.php" class="nav-link">Administration générale</a>
                    </li>
                    <li class="nav-item active"><a href="postAdmin.php" class="nav-link">Administration des Articles</a>
                    </li>
                    <li class="nav-item active"><a href="contactAdmin.php" class="nav-link">Administration des
                            Messages</a></li>
                    <li class="nav-item active"><a href="userAdmin.php" class="nav-link">Administration des
                            Utilisateurs</a></li>
                </ul>
            </div>
                ...
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                           ...
                           aria-expanded="false"><?= $_SESSION['authUser'] ?></a>
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a href="editUser.php?id=<?= $_SESSION['id'] ?>" class="dropdown-item"> Mon compte </a>
                            <a href="indexAdmin.php" class="dropdown-item">Administration</a>
