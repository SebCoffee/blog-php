...
if ($_SESSION['isAdmin'] == true) {
    ...
    <div class="entities-group">
        <form id="postCreationForm">
            ...
            <div class="form-group">
                <p> contenu : <textarea class="form-control" rows="15" style="resize: vertical !important;" id="content"
                                        name="content"><?= $post->content ?></textarea></p>
            </div>
            <div class="form-group">
                <p> url de l'image : <textarea class="form-control" id="image"
                                               name="image"><?= $post->image ?></textarea></p>
            </div>
            <div class="form-goup">
                <ul>
            ...
            <p>
                <button type="button" name="register" id="reg_btn" onclick="submitForm();"> Soumettre</button>
            </p>
        </form>
    </div>
